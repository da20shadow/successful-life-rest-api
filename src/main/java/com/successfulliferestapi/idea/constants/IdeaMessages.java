...
public class IdeaMessages {
    ...
    public static class Success {
        public static final String ADD = "Successfully added a new idea.";
        public static final String UPDATE = "Successfully updated the idea.";
        public static final String DELETE = "Successfully deleted the idea.";
    }
}
